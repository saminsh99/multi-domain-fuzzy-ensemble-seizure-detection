...
% Now you can use X and y for further processing (e.g., feature extraction, classification, etc.)
...
for i=1:Nt
    ...
    %this code segment is extracting EEG rhythms in the time domain by filtering signals through bandpass filters and extracting features from the filtered signals for further analysis or processing.
    for j= 1:size(band,2)
